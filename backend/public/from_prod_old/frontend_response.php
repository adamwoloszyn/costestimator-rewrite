	...
	class FrontEndResponse { 
		...
		private $responses = array(
			"1" => array(
				...
				"response_for_front_end_two" => "If you have any additional questions, please call us at 844.799.3243 so we can help. A member from our Every Mom Pledge team will not be contacting you.</b>",
				...
				"language_disclaimer" => "If you speak Spanish please contact a member from our Every Mom Pledge team at 844.799.3243 (we would translate this to Spanish)",
				"cost_estimate_id_message" => "Your cost estimate number is <b>[COST_ESTIMATE_ID]</b>. Please have your cost estimator ID number available when you speak to one of our Every Mom Pledge team members. ",
				"contains_cost_estimate" => true
			),
			"2" => array("response_for_front_end" => "Your estimated out-of-pocket is",
				"response_for_front_end_two" => "If you have any additional questions, please call us at 844.799.3243 so we can help. A member from our Every Mom Pledge team will not be contacting you.",
				"include_legal_disclaimer" => true,
			...
			"6" => array(
				"response_for_front_end" => "We are unable to return an estimate based on the information you provided. Please verify the insurance information entered is current.  If you would like to call one of our Every Mom Pledge team members directly, contact us at 844.799.3243.",
				"include_legal_disclaimer" => false,
	    ...
	    public function displayFrontEndMessage($dataToEvaluate){
			...
			if($dataToEvaluate["skipCHCAndPhoenix"] == "true"){
				
				return array("rule" => 8, "response_index" => 3, "response" => $responses[3], "data_to_evaluate" => $dataToEvaluate);
				
			}else if($dataToEvaluate["insurance_selection"] == "1"){//"I don't have insurance"
			...
			//}else if($service_status != "Active" || $dataToEvaluate["error_text"] == "No active coverage. Estimate cannot be calculated." || $dataToEvaluate["service_status"] == "No active coverage. Estimate cannot be calculated."){
				...
				return array("rule" => 6, "response_index" => 6, "response" => $responses[6], "data_to_evaluate" => $dataToEvaluate);
